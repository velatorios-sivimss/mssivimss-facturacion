...
public class FacturacionUtil {
	...
	public String obtServiciosODS(String idRegistro) {
		...
		query.append( "AND CP.IND_ACTIVO = 1\r\n"
				...
				+ "IFNULL(CONCAT(CS.CVE_PRODUCTOS_SERVICIOS, ' ', CS.REF_UNIDAD_SAT),'85171500 H87 PIEZA') AS claveSAT,\r\n"
				+ "IFNULL(CS.CVE_PRODUCTOS_SERVICIOS,'85171500') AS claveProd,\r\n"
				...
				+ "LEFT JOIN SVC_CLAVES_PRODUCTOS_SERVICIOS CS ON CS.ID_PRODUCTOS_SERVICIOS = ART.ID_PRODUCTOS_SERVICIOS\r\n"
				+ "WHERE\r\n"
				+ "CP.ID_ORDEN_SERVICIO = " );
		query.append( idRegistro );
		query.append( "\r\n" );
